...
<html>
  ...
  <?php
    ...
    */
    ...
    $destinataire = 'pierre.schuveye2n@gmail.com';
    ...
    $message_non_envoye = "Echec de l'envois, Try Again !";
    ...
    function NoSpamQuestion($mode = 'ask', $answer = 0)
    {
    	...
    	$array_pictures[$j]['question'] = "Ecrivez Nintendo si vous n'êtes pas un robot !" ;
    	$array_pictures[$j]['answer'] = "Nintendo";
    	$j++;

    	$array_pictures[$j]['num'] = $j;
    	$array_pictures[$j]['question'] = "Les robots de sont pas autorisés à l'envois prouvez votre humanité en écrivant Terminator !";
    	$array_pictures[$j]['answer'] = "Terminator";
    	$j++;

    	$array_pictures[$j]['num'] = $j;
    	$array_pictures[$j]['question'] = "Ecrire 12 en lettres et prouve ton humanité !";
    ...
    */
    ...
    if (isset($_POST['envoi']))
    {
    	...
    	if (strtolower($antispam_h) != strtolower($verif_nospam['answer']))
    	{
    		...
    		echo '<p>Quitte mes terres Machine ! Ou répond à ma question ! Merci.</p>';
    	}
    	else
    	{
    ...
    if (($err_formulaire) || (!isset($_POST['envoi'])))
    {
    	...
    	<div style="text-align:center;"><input type="submit" name="envoi" value="User de la Matrice pour envoyer le message !" /></div>
    	</form>';
    };
  ?>
  </body>
